  ...
  return (
    <div className="mx-auto max-w-5xl space-y-10 py-6 px-4 sm:px-6">
      ...
      <div className="glass-panel rounded-3xl p-8 border border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute -left-20 -bottom-20 h-64 w-64 rounded-full bg-slate-900/10 blur-3xl" />

        <div className="relative z-10 space-y-4 max-w-3xl">
          <div className="inline-flex items-center space-x-2 rounded-full bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-300 border border-blue-500/20">
            <BookOpen className="h-3.5 w-3.5" />
            <span>LLM Mechanics Deep Dive</span>
          </div>

          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-100 tracking-tight leading-tight bg-gradient-to-r from-slate-100 via-slate-200 to-blue-300 bg-clip-text text-transparent">
      ...
      <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-4 border border-slate-800">
        ...
        <div className="rounded-xl bg-slate-950 p-4 border border-slate-800 font-mono text-xs text-slate-200 overflow-x-auto">
      ...
      <section className="glass-panel rounded-2xl p-6 sm:p-8 space-y-6 border border-slate-800 shadow-2xl">
